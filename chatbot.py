...
"I can help you know more about ICLESMJC",
    ...
    "1",
    "<b>STUDENT <br>The following are frequently searched terms related to student . Please select one from the options below : <br> <br> 1.1 Curriculars <br>1.2  Extra-Curriculars<br>1.3  Administrative<br>1.4 Examination <br>1.5 Courses </b>",
    ...
    "1.1.2",
    "<b > 1.1.2 Academic Calender<br>The link to Academic Calender👉<a href=" 'https://iclesmj.edu.in/AllPages.aspx' ">Click Here</a> </b>",
    "1.1.3",
    ...
    "1.4",
    "<b > EXAMINATION <br>These are the top results:<br> 1.4.1 Notices<br> 1.4.2 Examination Timetable <br> 1.4.3 Sample Question Bank </b>",
    "1.4.1",
    "<b > 1.4.1 Notices<br>The link to Notices👉 <a href=" 'https://iclesmj.edu.in/AllPages.aspx' ">Click Here</a> </b>",
    "1.4.2",
    "<b > 1.4.2 Examination Timetable<br>The link to Examination Timetable👉<a href=" 'https://iclesmj.edu.in/AllPages.aspx' ">Click Here</a> </b>",
    "1.4.3",
    "<b > 1.4.3 Sample Question Bank<br>The link to Archives👉 <a href=" 'https://iclesmj.edu.in/AllPages.aspx' ">Click Here</a> </b>",

    "1.5",
    "<b > COURSES These are the top results:<br> 1.5.1 Courses<br> 1.5.2 Our Recruiters <br> 1.5.3 Placement Statistics </b>",
    "1.5.1",
    "<b> 1.5.1 Courses<br>The link to Courses👉 <a href=" 'https://iclesmj.edu.in/Default.aspx?#courses' ">Click Here</a> </b>",
    ...
    "4.1.1",
    "<b > 4.1.1 About CRCE<br>The link to About ICLESMJ👉 <a href=" 'https://iclesmj.edu.in/#about' ">Click Here</a> </b>",
    "4.1.2",
    "<b > 4.1.2 Director's Address <br>The link to Director's Address👉<a href=" 'https://iclesmj.edu.in/AllPages.aspx' ">Click Here</a> </b>",
    "4.1.3",
    "<b > 4.1.3 Principal's Address <br>The link to Principal's Address👉 <a href=" 'https://iclesmj.edu.in/AllPages.aspx' ">Click Here</a> </b>",

    "4.2",
    "<b > PROGRAMS WE OFFER <br>These are the top results:<br> <br>4.2.1 Under-Graduate <br> 4.2.2 Post-Graduate<br> 4.2.3 Jr. College <br> 4.2.4 Self Finance </b>",
    "4.2.1",
    "<b > 4.2.1 Under-Graduate<br>The link to Under-Graduate👉 <a href=" 'https://tezerp.com/Education/AdmissionForms/ICLES.aspx?x3Dx1Aox2+t9RPK%2fIKd7jw=%3d' ">Click Here</a> </b>",
    "4.2.2",
    "<b > 4.2.2 Post-Graduate <br>The link to Post-Graduate👉<a href=" 'https://tezerp.com/Education/AdmissionForms/ICLES.aspx?x3Dx1Aox2+t9RPK%2fIKd7jw=%3d' ">Click Here</a> </b>",
    "4.2.3",
    "<b > 4.2.3 Jr. College <br>The link to Jr. College👉 <a href=" 'https://tezerp.com/Education/AdmissionForms/ICLES.aspx?x3Dx1Aox2+t9RPK%2fIKd7jw=%3d' ">Click Here</a> </b>",
    "4.2.4",
    "<b > 4.2.4 Self Finance <br>The link to Self Finance👉 <a href=" 'https://tezerp.com/Education/AdmissionForms/ICLES.aspx?x3Dx1Aox2+t9RPK%2fIKd7jw=%3d' ">Click Here</a> </b>",
